...
# 配置
PROJECT_NAME="food-subscription-v1.1"
...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}  食材包订阅平台部署脚本 (v1.1)${NC}"
echo -e "${BLUE}========================================${NC}"
echo ""
...
server {
    ...
    # 上传文件
    location /uploads/ {
        alias /var/www/food-subscription-v1.1/backend/uploads/;
        expires 30d;
...
[Unit]
Description=Food Subscription Platform Backend (v1.1)
