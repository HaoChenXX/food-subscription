...
export const translations = {
  zh: {
    ...
    'auth.terms.title': '服务条款',
    'auth.register.and': '和',
    'auth.register.privacy': '隐私政策',
    'auth.privacy.title': '隐私政策',
    'auth.terms.lastUpdated': '最后更新日期：2026年3月9日',
